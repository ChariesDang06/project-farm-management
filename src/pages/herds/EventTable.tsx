...
type EventsTableProps = {
  filterCamId?: string;             // Lọc theo 1 camera ID
  filterBarnCameraIDs?: string[];   // Lọc theo nhiều camera ID của chuồng
};
  ...
  const downloadButtonTemplate = (rowData: Event) => {
    ...
    return (
      <div
        ...
        onClick={() => {
          window.open(
            `http://localhost:8000/download/${rowData.video_recorded}`,
            "_blank"
          );
        }}
      >
