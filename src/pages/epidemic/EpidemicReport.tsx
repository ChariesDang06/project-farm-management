  ...
  return (
    <div className="bg-[#F3F7F5] rounded-[16px] p-5">
      ...
      <div className="bg-[#FFFFF1] mt-4 p-4 rounded-[20px]">
        <h2 className="text-md sm:text-lg text-left font-semibold mb-4">
        ...
        <div className="space-y-4">
          {cases.map((disease) => (
            <div
              key={disease.id}
              className="px-4 p-4 rounded-lg border border-[#A1A3AB]"
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="flex flex-col gap-3 md:col-span-1 text-left">
                  <InputField
                    ...
                    onChange={(val) =>
                      handleChange(disease.id, "importedQuantity", val)
                    }
                    type="number"
                  />
                  <InputField
                    ...
                    onChange={(val) =>
                      handleChange(disease.id, "destroyedQuantity", val)
                    }
                    type="number"
                  />
                </div>
                  ...
                  <div className="relative">
                    {editingNoteId === disease.id ? (
                      <textarea
                        value={disease.note}
                        onChange={(e) =>
                          handleChange(disease.id, "note", e.target.value)
                        }
